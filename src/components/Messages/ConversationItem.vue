...
<template>
  <div
      :class="props.actualConversation?.id === props.conversation.id ? 'n-color-status-info-weak n-padding-s n-margin-be-s  item-list' : 'n-margin-be-s n-padding-s item-list'">
