...
<template>
    <form @submit.prevent="!!request ? update() : store()">
        <nord-stack>
            ...
            <div class="n-stack n-gap-s">
                <nord-input v-if="props.request" label="Personnel administratif"
                            disabled
                            expand
            ...
            <nord-stack direction="horizontal" justify-content="">
                ...
                <fieldset>
                    ...
                    <nord-stack direction="vertical">
                        <TheRadioInput v-model="isValidatedAdmin" :item="{label: '<nord-icon class=\'n-color-text-weaker\' name=\'interface-time\'></nord-icon>', disabled: false, value: 'null'}"/>
                        <TheRadioInput v-model="isValidatedAdmin" :item="{label: '<nord-icon class=\'n-color-text-success\' name=\'interface-checked-small\'></nord-icon>', disabled: false, value: 'true'}"/>
                        <TheRadioInput v-model="isValidatedAdmin" :item="{label: '<nord-icon class=\'n-color-text-error\' name=\'interface-close-small\'></nord-icon>', disabled: false, value: 'false'}"/>
                    </nord-stack>
                </fieldset>
            </nord-stack>
